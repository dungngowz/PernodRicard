...
use DrinksAndCo\Experience\Model\Resource\Post as PostResource;
use DrinksAndCo\Experience\Model\Resource\Post\Collection;
use DrinksAndCo\Experience\Helper\Data;
use Magento\Framework\UrlInterface;
use DrinksAndCo\Experience\Model\Category;
use DrinksAndCo\Experience\Model\Comment;
...
class Post extends AbstractModel
{
    ...
    {
        parent::_construct();
        $this->_init('DrinksAndCo\Experience\Model\Resource\Post');
    }
    ...
    {
        $route = $this->experienceHelper->getRoute();
