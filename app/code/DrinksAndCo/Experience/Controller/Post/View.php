...
class View extends \Magento\Framework\App\Action\Action
{
    ...
    public function __construct(
        ...
        \DrinksAndCo\Experience\Model\Post $postModel,
    ...
    public function execute()
    {
        ...
        if ($post) {
            ...
            if ($this->experienceHelper->getConfig('general_settings/template_detail')) {
                $resultPage->getConfig()->setPageLayout($this->experienceHelper->getConfig('general_settings/template_detail'));
            }
            return $resultPage;
        } else {
            return $this->resultForwardFactory->create()->forward('noroute');
