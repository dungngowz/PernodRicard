...
class View extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $message = __('Are you sure you want to send an order sms to customer?');
        $this->addButton(
            'send_notification_sms',
            [
                'label' => __('Send SMS'),
                'class' => 'send-sms',
                'onclick' => "confirmSetLocation('{$message}', '{$this->getSmsUrl()}')"
            ]
        );
    ...
    {
        return $this->getUrl('customizeorder/order/sms');
    }
