...
namespace DrinksAndCo\Region\Block\Adminhtml\Region;
...
class Edit extends Container
{
    ...
    {
        $this->_objectId = 'drinksandco_region_id';
        $this->_blockGroup = 'DrinksAndCo_Region';
        $this->_controller = 'adminhtml_region';
        parent::_construct();

        if ($this->_isAllowedAction('DrinksAndCo_Region::region_edit')) {
            ...
            $region = $this->_coreRegistry->registry('drinksandco_region');
            if(!empty($region)) {
