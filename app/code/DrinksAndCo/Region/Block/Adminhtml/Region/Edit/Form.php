...
namespace DrinksAndCo\Region\Block\Adminhtml\Region\Edit;
...
class Form extends Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $country_list = $this->_coreRegistry->registry('drinksandco_region_country_list');
        ...
        $formData = $this->_coreRegistry->registry('drinksandco_region');
        if ($formData) {
