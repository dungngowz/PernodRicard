...
namespace DrinksAndCo\Blog\Model;

use Magento\Framework\Model\AbstractModel;
use Magento\Framework\Model\Context;
use Magento\Framework\Registry;
use Magento\Store\Model\StoreManagerInterface;
use DrinksAndCo\Blog\Model\Resource\Post as PostResource;
use DrinksAndCo\Blog\Model\Resource\Post\Collection;
use DrinksAndCo\Blog\Helper\Data;
use Magento\Framework\UrlInterface;
use DrinksAndCo\Blog\Model\Category;
use DrinksAndCo\Blog\Model\Comment;
...
class Post extends AbstractModel
{
    ...
    {
        parent::_construct();
        $this->_init('DrinksAndCo\Blog\Model\Resource\Post');
    }
