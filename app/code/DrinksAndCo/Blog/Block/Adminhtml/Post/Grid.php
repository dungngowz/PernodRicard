...
namespace DrinksAndCo\Blog\Block\Adminhtml\Post;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \DrinksAndCo\Blog\Model\Post $post,
        \DrinksAndCo\Blog\Model\Resource\Post\Grid\CollectionFactory $collectionFactory,
        array $data = []
    )
    {
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                'header' => __('Thumbnail'),
                'index' => 'small_image',
                'renderer' => '\DrinksAndCo\Blog\Block\Adminhtml\Post\Grid\Renderer\Thumbnail',
                'sortable' => false,
                'filter' => false
            ]
        );
