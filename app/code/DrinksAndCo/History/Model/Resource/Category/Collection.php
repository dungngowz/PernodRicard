...
namespace DrinksAndCo\History\Model\Resource\Category;

use DrinksAndCo\History\Model\Resource\CategoryCollection;
...
class Collection extends CategoryCollection
{
    ...
    {
        $this->_init('DrinksAndCo\History\Model\Category', 'DrinksAndCo\History\Model\Resource\Category');
    ...
    {
        $this->performAfterLoad('DrinksAndCo_History_category_store', 'category_id');
    ...
    {
        $this->joinStoreRelationTable('DrinksAndCo_History_category_store', 'category_id');
    }
}
