...
namespace DrinksAndCo\History\Controller;
...
use DrinksAndCo\History\Model\Post;
...
class Router implements RouterInterface
{
    ...
    public function match(RequestInterface $request)
    {
        ...
        if (!$this->dispatched) {
            $route = $historyHelper->getConfig('general_settings/route');
            $urlKey = trim($request->getPathInfo(), '/');
            $origUrlKey = $urlKey;
            $condition = new DataObject(['url_key' => $urlKey, 'continue' => true]);
            $this->eventManager->dispatch(
                'DrinksAndCo_History_controller_router_match_before',
