...
namespace DrinksAndCo\News\Block\Category;
...
class Posts extends \Magento\Framework\View\Element\Template
{
    ...
    public function getLoadMoreNews(){
        return trim($this->getUrl('news/loadmore/news?' . $this->getParamsSearch()), '/');
    }
