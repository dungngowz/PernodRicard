...
namespace DrinksAndCo\News\Block\Adminhtml\Post\Edit\Tab;
...
use DrinksAndCo\News\Model\System\Config\Status;
use DrinksAndCo\News\Model\System\Config\Yesno;
use DrinksAndCo\News\Model\Source\Category;
...
class Main extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            'label',
            'text',
            ['name' => 'post[label]', 'label' => __('Label'), 'title' => __('Label'), 'required' => false]
        );
        ...
        //     ]
        // );
        // $renderer = $this->getLayout()->createBlock('DrinksAndCo\News\Block\Adminhtml\Color');
        ...
        $fieldset->addField(
            'related_image',
            'image',
            ['name' => 'related_image', 'label' => __('Related Image'),'note' => __('Show on related products'), 'title' => __('Related Image'), 'required' => false]
        );

        $fieldset->addField(
            'image',
            'image',
            ['name' => 'image', 'label' => __('Image'),'note' => __('Show on Post Detail'), 'title' => __('Image'), 'required' => false]
        );
