...
use DrinksAndCo\News\Model\Resource\Category as CategoryResource;
use DrinksAndCo\News\Model\Resource\Category\Collection;
...
class Category extends AbstractModel
{
    ...
    {
        parent::_construct();
        $this->_init('DrinksAndCo\News\Model\Resource\Category');
    }
