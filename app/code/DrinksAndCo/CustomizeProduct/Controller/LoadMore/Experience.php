...
class Experience extends \Magento\Framework\App\Action\Action
{
	...
	public function execute()
	{
		$html = $this->_view->getLayout()
                 ->createBlock("DrinksAndCo\CustomizeProduct\Block\Experience")
                 ->setTemplate("DrinksAndCo_CustomizeProduct::experience/load-more-experience.phtml")
				 ->toHtml();
